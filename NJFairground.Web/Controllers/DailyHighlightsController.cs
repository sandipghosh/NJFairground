...
namespace NJFairground.Web.Controllers
{
    ...
    public class DailyHighlightsController : BaseController
    {
        private readonly IPageItemDataRepository _pageItemDataRepository;

        /// <summary>
        /// Initializes a new instance of the <see cref="DailyHighlightsController"/> class.
        /// </summary>
        ...
        public ActionResult Index()
        {
            List<PageItemModel> pageItems = this._pageItemDataRepository
                .GetList(x => x.PageId == Convert.ToInt32(Page.DailyHighlights)
