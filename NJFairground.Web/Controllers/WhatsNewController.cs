...
namespace NJFairground.Web.Controllers
{
    ...
    public class WhatsNewController : BaseController
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsNewController"/> class.
        /// </summary>
        /// <param name="pageItemDataRepository">The page item data repository.</param>
        public WhatsNewController(IPageItemDataRepository pageItemDataRepository)
        {
        ...
        {
            List<PageItemModel> pageItems = this._pageItemDataRepository.GetList(x => x.PageId == Convert.ToInt32(Page.WhatsNew) && x.StatusId == 1).ToList();
