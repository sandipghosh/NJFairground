...
namespace NJFairground.Web.Data.Implementation
{
    ...
    public class UserImageDataRepository
        : DataRepository<UserImage, UserImageModel>, IUserImageDataRepository
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageDataRepository"/> class.
        /// </summary>
        /// <param name="unitOfWork">The unit of work.</param>
        public UserImageDataRepository(UnitOfWork<NJFairgroundDBEntities> unitOfWork)
            : base(unitOfWork)
        {
        }
    }
