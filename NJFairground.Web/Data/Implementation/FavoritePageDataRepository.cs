...
namespace NJFairground.Web.Data.Implementation
{
    ...
    public class FavoritePageDataRepository
        : DataRepository<FavoritePage, FavoritePageModel>, IFavoritePageDataRepository
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageDataRepository"/> class.
        /// </summary>
        /// <param name="unitOfWork">The unit of work.</param>
        public FavoritePageDataRepository(UnitOfWork<NJFairgroundDBEntities> unitOfWork)
            : base(unitOfWork)
        {
        }
    }
