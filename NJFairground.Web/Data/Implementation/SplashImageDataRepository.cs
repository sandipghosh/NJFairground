...
namespace NJFairground.Web.Data.Implementation
{
    ...
    public class SplashImageDataRepository
        : DataRepository<SplashImage, SplashImageModel>, ISplashImageDataRepository
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageDataRepository"/> class.
        /// </summary>
        /// <param name="unitOfWork">The unit of work.</param>
        public SplashImageDataRepository(UnitOfWork<NJFairgroundDBEntities> unitOfWork)
            : base(unitOfWork)
        {
        }
    }
