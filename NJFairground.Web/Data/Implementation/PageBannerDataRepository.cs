...
namespace NJFairground.Web.Data.Implementation
{
    ...
    public class PageBannerDataRepository
        : DataRepository<PageBanner, PageBannerModel>, IPageBannerDataRepository
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageDataRepository"/> class.
        /// </summary>
        /// <param name="unitOfWork">The unit of work.</param>
        public PageBannerDataRepository(UnitOfWork<NJFairgroundDBEntities> unitOfWork)
            : base(unitOfWork)
        {
        }
    }
